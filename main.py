...
Assegna un punteggio intero da -20 a +20 in base ai fattori latenti che hai individuato. È SEVERAMENTE VIETATO ASSEGNARE +0. Devi obbligatoriamente sbilanciarti e prendere una posizione. Trova sempre almeno una sfumatura latente (es. tono dell'annuncio, verbosità, chiarezza, appeal formativo) che ti spinga a premiare (es. +2, +5) o a penalizzare (es. -2, -5) l'offerta.
...
- fit_score_reasoning: IN ITALIANO, ELENCO PUNTATO strutturato. Elenca i singoli fattori che hanno determinato il punteggio, SEPARANDO chiaramente i criteri del profilo dal tuo giudizio personale:
  ...
  * Punteggio extra fattori latenti: [Da -20 a +20 (ESCLUSO LO ZERO) in base ai SOLI fattori appena descritti. DEVI SBILANCIARTI!]
